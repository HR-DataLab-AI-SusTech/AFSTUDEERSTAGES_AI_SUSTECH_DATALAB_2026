...
| ------------- | ------------- | ---------- |
*––DT–– <br> Digital Twins*  | Ontwerpen van FAIR data products en digital twins die AI-modellen benutten voor simulatie en optimalisatie van duurzame systemen, zoals binnenvaartcorridors ([Path2Zero](https://www.hogeschoolrotterdam.nl/onderzoek/projecten-en-publicaties/coe-hrtech/slimme-logistiek--maritieme-innovatie/path2zero-transitie-naar-emissievrije-binnenvaart/)/ [Ab Initio](https://www.debinnenvaart.nl/schip_detail/ab-initio/)), warmtepompen en windturbines ([PEOPLE](https://www.hogeschoolrotterdam.nl/hogeschool/nieuws/newsitem/miljoenensubsidie-nationaal-groeifonds-voor-aanpak-tekort-technisch-personeel/446950/)). |  [Matlab Simulink/  <br> Prometheus + Grafana  / <br> Game Engines (UNREAL / UNITY) / <br> Siemens Simcenter ](https://github.com/robvdw/MATLAB_REGRESSION_LEARNER). 
